...
/**
 * Zero-dependency bundler for aad-bridged.
 *
 * Inlines server.js + lib/*.js into a single self-contained file by wrapping each module's source in a function and registering it under its path.
 ...
 *
 * Usage: node build.js            -> dist/aad-bridged.js
 */
...
const OUT_FILE = path.join(OUT_DIR, 'aad-bridged.js');
...
function build() {
  ...
  parts.push(`// aad-bridged ${pkg.version} — bundled, do not edit. Source: aad-bridge/, rebuild: node build.js`);
  parts.push('');
